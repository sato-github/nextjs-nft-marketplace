...
contract NftMarket is ERC721URIStorage, Ownable {
    ...
    // // _beforeTokenTransfer will be called inside _burn funtion
    ...
    function buyNft(uint256 tokenId) public payable {
        ...
        require(msg.sender != owner, "You already own this NFT."); //msg.sender should not be equal to owner
        require(msg.value == price, "Please submit the asking price."); // msg.value should be equal to proce of NFT
